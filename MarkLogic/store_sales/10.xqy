...
<query10>{
  ...
  let $build :=
    for $doc in doc()
    for $sales in $doc[(((item/i_category="Music" or item/i_category="Home" or item/i_category="Sports") and (item/i_class="country" or item/i_class="rugs" or item/i_class="fishing")) or ((item/i_category="Women" or item/i_category="Men" or item/i_category="Children") and (item/i_class="swimwear" or item/i_class="shirts" or item/i_class="pants"))) and date/d_year=2000]
