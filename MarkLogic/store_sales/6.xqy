...
<query6>{
  ...
  let $build :=
    for $doc in doc()
    for $sales in $doc[date/d_dom>=20 and date/d_dom<=21 and date/d_year>=1999 and date/d_year<=2001 and s_city="Midway" and (customer/hd_dep_count=4 or customer/hd_vehicle_count=2)]
