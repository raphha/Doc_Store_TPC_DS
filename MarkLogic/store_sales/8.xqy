...
<query8>{
  ...
  let $build :=
    for $doc in doc()
    for $sales in $doc[date/d_dow=1 and date/d_year>=1998 and date/d_year<=2000 and s_number_employees>=200 and s_number_employees<=295 and (customer/hd_dep_count=5 or customer/hd_vehicle_count>2)]
