...
<query12>{
  let $m := map:map()
  let $build :=
    for $sales in doc()/store_sales[(item/i_category="Music" or item/i_category="Home" or item/i_category="Sports") and date/d_date>="2002-01-01" and date/d_date<="2002-01-31"]
