...
<query4>{
  let $m := map:map()
  let $build :=
    for $sales in doc()[d_year=2001]/store_sales[s_state="TN" and customer/cd_gender="F" and customer/cd_marital_status="S" and customer/cd_education_status="Secondary"]
