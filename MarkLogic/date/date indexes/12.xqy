...
cts:json-property-range-query("d_date", ">=", "2002-01-01"),
cts:json-property-range-query("d_date", "<=", "2002-01-31")
))
)
    for $sales in $doc/store_sales[(item/i_category="Music" or item/i_category="Home" or item/i_category="Sports")]
